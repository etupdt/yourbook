...
RUN cat /usr/local/apache2/conf/httpd-vhosts.conf | grep -v "httpd-vhosts-443.conf" > /usr/local/apache2/conf/httpd-vhosts.conf
RUN echo "Include /usr/local/apache2/conf/httpd-vhosts-443.conf" >> /usr/local/apache2/conf/httpd-vhosts.conf
